...
# by tag_name
    ...
    button_2 = driver.find_element(By.XPATH, "//button")    # XPath
    ...
    links_2 = driver.find_elements(By.XPATH, "//a")
    ...
    start_input = driver.find_element(By.CSS_SELECTOR,"[placeholder ^= 'Type']")
    start_input_xPath = driver.find_element(By.XPATH,"//input[starts-with(@placeholder,'Type')]")
...
#Canada
    ...
    assert canada.text == 'Canada'  # Проверь, что в ячейке Canada -> текст Canada
